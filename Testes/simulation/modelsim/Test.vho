...
-- SS	=>  Location: PIN_P10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SCLK	=>  Location: PIN_B19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SDX	=>  Location: PIN_C12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- accept	=>  Location: PIN_AB10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Wrl	=>  Location: PIN_C9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF SLCDC_Wrapper IS
...
SIGNAL \sr|c|mux|Y~0_combout\ : std_logic;
SIGNAL \sr|c|reg|ff1|Q~q\ : std_logic;
SIGNAL \sr|c|ad|fa3|S~combout\ : std_logic;
SIGNAL \sr|c|mux|Y~2_combout\ : std_logic;
...
SIGNAL \sr|c|mux|Y~1_combout\ : std_logic;
...
SIGNAL \lcdd|cup|mux|Y~0_combout\ : std_logic;
SIGNAL \lcdd|cup|reg|ff0|Q~q\ : std_logic;
SIGNAL \lcdd|cup|mux|Y~1_combout\ : std_logic;
SIGNAL \lcdd|cup|reg|ff1|Q~q\ : std_logic;
SIGNAL \lcdd|cup|mux|Y~2_combout\ : std_logic;
SIGNAL \lcdd|cup|reg|ff2|Q~q\ : std_logic;
SIGNAL \lcdd|cup|mux|Y~3_combout\ : std_logic;
SIGNAL \lcdd|cup|mux|Y~4_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	dataa => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|design_hash_reg[0]~9_combout\,
...
-- Equation(s):
-- \lcdd|Selector2~1_combout\ = (\lcdd|Selector2~0_combout\ & ((\lcdd|CurrentState.SECOND~q\) # ((\sr|sc|CurrentState.THIRD~q\ & \lcdd|CurrentState.THIRD~q\)))) # (!\lcdd|Selector2~0_combout\ & (\sr|sc|CurrentState.THIRD~q\ & (\lcdd|CurrentState.THIRD~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \lcdd|Selector2~0_combout\,
	datab => \sr|sc|CurrentState.THIRD~q\,
...
-- Equation(s):
-- \sr|sc|Selector1~0_combout\ = (!\sr|sc|CurrentState.FORTH~q\ & (!\auto_hub|instr
-- umentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\ & !\sr|sc|CurrentState.THIRD~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \sr|sc|CurrentState.FORTH~q\,
...
-- Equation(s):
-- \sr|sc|NextState.FORTH~0_combout\ = (\sr|sc|CurrentState.FIRST~q\ & (\lcdd|CurrentState.THIRD~q\ & !\sr|sc|CurrentState.SECOND~q\))
...
PORT MAP (
	...
	datab => \lcdd|CurrentState.THIRD~q\,
	datad => \sr|sc|CurrentState.SECOND~q\,
...
-- Equation(s):
-- \sr|sc|Selector0~0_combout\ = (\sr|sc|CurrentState.FORTH~q\ & (((\auto_hub|instr
-- umentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\ & !\sr|sc|CurrentState.FIRST~q\)) # (!\lcdd|CurrentState.THIRD~q\))) 
-- # (!\sr|sc|CurrentState.FORTH~q\ & (((\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\ & 
-- !\sr|sc|CurrentState.FIRST~q\))))
...
PORT MAP (
	...
	datab => \lcdd|CurrentState.THIRD~q\,
	datac => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\,
	datad => \sr|sc|CurrentState.FIRST~q\,
	combout => \sr|sc|Selector0~0_combout\);

-- Location: LCCOMB_X47_Y49_N20
\sr|c|mux|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sr|c|mux|Y~0_combout\ = (\sr|c|reg|ff1|Q~q\ $ (((!\sr|c|reg|ff0|Q~q\ & \sr|sc|CurrentState.SECOND~q\)))) # (!\sr|sc|CurrentState.FIRST~q\)
...
PORT MAP (
	dataa => \sr|sc|CurrentState.FIRST~q\,
	datab => \sr|c|reg|ff0|Q~q\,
	datac => \sr|c|reg|ff1|Q~q\,
	datad => \sr|sc|CurrentState.SECOND~q\,
	combout => \sr|c|mux|Y~0_combout\);
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][3]~clkctrl_outclk\,
	d => \sr|c|mux|Y~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \sr|c|reg|ff1|Q~q\);

-- Location: LCCOMB_X47_Y49_N24
\sr|c|ad|fa3|S\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sr|c|ad|fa3|S~combout\ = \sr|c|reg|ff2|Q~q\ $ ((((\sr|c|reg|ff0|Q~q\) # (\sr|c|reg|ff1|Q~q\)) # (!\sr|sc|CurrentState.SECOND~q\)))
...
PORT MAP (
	...
	datab => \sr|c|reg|ff2|Q~q\,
	datac => \sr|c|reg|ff0|Q~q\,
	datad => \sr|c|reg|ff1|Q~q\,
	combout => \sr|c|ad|fa3|S~combout\);

-- Location: LCCOMB_X47_Y49_N16
\sr|c|mux|Y~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sr|c|mux|Y~2_combout\ = (!\sr|sc|CurrentState.FIRST~q\) # (!\sr|c|ad|fa3|S~combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \sr|c|ad|fa3|S~combout\,
	datad => \sr|sc|CurrentState.FIRST~q\,
	combout => \sr|c|mux|Y~2_combout\);
...
-- Equation(s):
-- \sr|sc|Selector2~2_combout\ = (!\sr|c|reg|ff2|Q~q\ & (!\sr|c|reg|ff0|Q~q\ & \sr|c|reg|ff1|Q~q\))
...
-- Equation(s):
-- \sr|sc|Selector0~1_combout\ = (!\sr|sc|Selector0~0_combout\ & ((\sr|sc|Selector2~2_combout\) # ((!\sr|sc|CurrentState.SECOND~q\) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \sr|sc|Selector0~0_combout\,
	datab => \sr|sc|Selector2~2_combout\,
	datac => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\,
	datad => \sr|sc|CurrentState.SECOND~q\,
...
\sr|c|mux|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sr|c|mux|Y~1_combout\ = (\sr|c|reg|ff0|Q~q\ $ (\sr|sc|CurrentState.SECOND~q\)) # (!\sr|sc|CurrentState.FIRST~q\)
...
-- Equation(s):
-- \sr|sc|Selector2~0_combout\ = (!\sr|c|reg|ff0|Q~q\ & (!\sr|c|reg|ff2|Q~q\ & (\au
-- to_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\ & \sr|sc|CurrentState.SECOND~q\)))
...
-- Equation(s):
-- \sr|sc|Selector2~1_combout\ = (\sr|sc|Selector2~0_combout\ & ((\sr|c|reg|ff1|Q~q\) # ((\sr|sc|CurrentState.THIRD~q\ & !\lcdd|CurrentState.THIRD~q\)))) # (!\sr|sc|Selector2~0_combout\ & (((\sr|sc|CurrentState.THIRD~q\ & !\lcdd|CurrentState.THIRD~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \sr|sc|Selector2~0_combout\,
...
-- Equation(s):
-- \lcdd|Selector0~0_combout\ = (\sr|sc|CurrentState.THIRD~q\) # (\lcdd|CurrentState.SECOND~q\)
...
\lcdd|cup|mux|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \lcdd|cup|mux|Y~0_combout\ = (!\lcdd|CurrentState.FIRST~q\) # (!\lcdd|cup|reg|ff0|Q~q\)
...
PORT MAP (
	...
	datad => \lcdd|CurrentState.FIRST~q\,
	combout => \lcdd|cup|mux|Y~0_combout\);
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \lcdd|cup|mux|Y~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \lcdd|cup|reg|ff0|Q~q\);

-- Location: LCCOMB_X47_Y51_N4
\lcdd|cup|mux|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \lcdd|cup|mux|Y~1_combout\ = (\lcdd|cup|reg|ff1|Q~q\ $ (!\lcdd|cup|reg|ff0|Q~q\)) # (!\lcdd|CurrentState.FIRST~q\)
...
PORT MAP (
	...
	datad => \lcdd|cup|reg|ff0|Q~q\,
	combout => \lcdd|cup|mux|Y~1_combout\);
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \lcdd|cup|mux|Y~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \lcdd|cup|reg|ff1|Q~q\);

-- Location: LCCOMB_X47_Y51_N22
\lcdd|cup|mux|Y~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \lcdd|cup|mux|Y~2_combout\ = (\lcdd|cup|reg|ff2|Q~q\ $ (((!\lcdd|cup|reg|ff1|Q~q\ & !\lcdd|cup|reg|ff0|Q~q\)))) # (!\lcdd|CurrentState.FIRST~q\)
...
PORT MAP (
	...
	datad => \lcdd|cup|reg|ff0|Q~q\,
	combout => \lcdd|cup|mux|Y~2_combout\);
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \lcdd|cup|mux|Y~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \lcdd|cup|reg|ff2|Q~q\);

-- Location: LCCOMB_X47_Y51_N24
\lcdd|cup|mux|Y~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \lcdd|cup|mux|Y~3_combout\ = (!\lcdd|cup|reg|ff2|Q~q\ & !\lcdd|cup|reg|ff0|Q~q\)
...
PORT MAP (
	datac => \lcdd|cup|reg|ff2|Q~q\,
	datad => \lcdd|cup|reg|ff0|Q~q\,
	combout => \lcdd|cup|mux|Y~3_combout\);

-- Location: LCCOMB_X47_Y51_N0
\lcdd|cup|mux|Y~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \lcdd|cup|mux|Y~4_combout\ = (\lcdd|cup|reg|ff3|Q~q\ $ (((!\lcdd|cup|reg|ff1|Q~q\ & \lcdd|cup|mux|Y~3_combout\)))) # (!\lcdd|CurrentState.FIRST~q\)
...
PORT MAP (
	...
	datad => \lcdd|cup|mux|Y~3_combout\,
	combout => \lcdd|cup|mux|Y~4_combout\);
...
-- Equation(s):
-- \lcdd|Selector2~0_combout\ = (!\lcdd|cup|reg|ff2|Q~q\ & (!\lcdd|cup|reg|ff3|Q~q\ & (\lcdd|cup|reg|ff1|Q~q\ & \lcdd|cup|reg|ff0|Q~q\)))
...
-- Equation(s):
-- \lcdd|Selector1~0_combout\ = (\lcdd|Selector2~0_combout\ & (\sr|sc|CurrentState.THIRD~q\ & ((!\lcdd|CurrentState.FIRST~q\)))) # (!\lcdd|Selector2~0_combout\ & ((\lcdd|CurrentState.SECOND~q\) # ((\sr|sc|CurrentState.THIRD~q\ & 
-- !\lcdd|CurrentState.FIRST~q\))))
...
-- Equation(s):
-- \sr|sr|ffd4|Q~0_combout\ = !\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][2]~q\
