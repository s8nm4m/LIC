...
SIGNAL \sl|sr|fsc|Q~clkctrl_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \kr|kd|scan|count|reg|ff3|Q~1_combout\ : std_logic;
...
SIGNAL \sl|sr|fsc|Q~0_combout\ : std_logic;
SIGNAL \sl|sr|fsc|Q~q\ : std_logic;
SIGNAL \sl|sr|fsc|Q~clkctrl_outclk\ : std_logic;
...
SIGNAL \sl|sr|f|Q~0_combout\ : std_logic;
SIGNAL \sl|sr|f|Q~q\ : std_logic;
...
SIGNAL \sl|sr|fsc|ALT_INV_Q~clkctrl_outclk\ : std_logic;
...
\sl|sr|fsc|Q~clkctrl_INCLK_bus\ <= (vcc & vcc & vcc & \sl|sr|fsc|Q~q\);
...
\sl|sr|fsc|ALT_INV_Q~clkctrl_outclk\ <= NOT \sl|sr|fsc|Q~clkctrl_outclk\;
...
-- Equation(s):
-- \kr|kd|clock|Equal0~5_combout\ = (!\kr|kd|clock|count\(18) & (!\kr|kd|clock|count\(19) & (!\kr|kd|clock|count\(17) & !\kr|kd|clock|count\(16))))
...
-- Equation(s):
-- \kr|kd|clock|Equal0~7_combout\ = (!\kr|kd|clock|count\(25) & (!\kr|kd|clock|count\(26) & (!\kr|kd|clock|count\(24) & !\kr|kd|clock|count\(27))))
...
-- pragma translate_on
PORT MAP (
	dataa => \kr|kd|clock|count\(25),
	datab => \kr|kd|clock|count\(26),
	datac => \kr|kd|clock|count\(24),
	datad => \kr|kd|clock|count\(27),
...
-- Equation(s):
-- \kr|kd|clock|Equal0~9_combout\ = (\kr|kd|clock|Equal0~5_combout\ & (\kr|kd|clock|Equal0~7_combout\ & (\kr|kd|clock|Equal0~8_combout\ & \kr|kd|clock|Equal0~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \kr|kd|clock|Equal0~5_combout\,
	datab => \kr|kd|clock|Equal0~7_combout\,
...
-- Equation(s):
-- \kr|kd|clock|count~0_combout\ = (\kr|kd|clock|Add0~4_combout\ & ((!\kr|kd|clock|Equal0~9_combout\) # (!\kr|kd|clock|Equal0~4_combout\)))
...
-- Equation(s):
-- \kr|kd|clock|Equal0~2_combout\ = (!\kr|kd|clock|count\(11) & (!\kr|kd|clock|count\(10) & (\kr|kd|clock|count\(8) & !\kr|kd|clock|count\(9))))
...
-- Equation(s):
-- \kr|kd|clock|Equal0~0_combout\ = (\kr|kd|clock|count\(0) & (!\kr|kd|clock|count\(3) & (\kr|kd|clock|count\(2) & !\kr|kd|clock|count\(1))))
...
PORT MAP (
	...
	datab => \kr|kd|clock|count\(3),
	datac => \kr|kd|clock|count\(2),
...
-- Equation(s):
-- \kr|kd|clock|Equal0~3_combout\ = (!\kr|kd|clock|count\(12) & (!\kr|kd|clock|count\(13) & (!\kr|kd|clock|count\(14) & !\kr|kd|clock|count\(15))))
...
PORT MAP (
	...
	datad => \kr|kd|clock|count\(15),
	combout => \kr|kd|clock|Equal0~3_combout\);

-- Location: LCCOMB_X8_Y15_N12
\kr|kd|clock|Equal0~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \kr|kd|clock|Equal0~4_combout\ = (\kr|kd|clock|Equal0~2_combout\ & (\kr|kd|clock|Equal0~0_combout\ & (\kr|kd|clock|Equal0~1_combout\ & \kr|kd|clock|Equal0~3_combout\)))
...
PORT MAP (
	...
	datad => \kr|kd|clock|Equal0~3_combout\,
	combout => \kr|kd|clock|Equal0~4_combout\);

-- Location: LCCOMB_X8_Y15_N0
\kr|kd|clock|tmp~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \kr|kd|clock|tmp~0_combout\ = \kr|kd|clock|tmp~q\ $ (((\kr|kd|clock|Equal0~4_combout\ & \kr|kd|clock|Equal0~9_combout\)))
...
-- Equation(s):
-- \kr|kd|scan|count|reg|ff3|Q~0_combout\ = (\kr|kd|control|CurrentState.FIRST~q\) # ((!\kr|kd|scan|count|reg|ff1|Q~q\) # (!\kr|kd|scan|count|reg|ff0|Q~q\))
...
-- Equation(s):
-- \kr|kd|scan|count|ad|fa2|Co~0_combout\ = (!\kr|kd|control|CurrentState.FIRST~q\ & (\kr|kd|scan|count|reg|ff0|Q~q\ & (\kr|kd|scan|mux|Y~1_combout\ & \kr|kd|scan|count|reg|ff1|Q~q\)))
...
-- Equation(s):
-- \kr|kd|scan|count|reg|ff2|Q~0_combout\ = \kr|kd|scan|count|ad|fa2|Co~0_combout\ $ (\kr|kd|scan|count|reg|ff2|Q~q\)
...
PORT MAP (
	...
	d => \kr|kd|scan|count|reg|ff2|Q~0_combout\,
...
\kr|kd|scan|count|reg|ff3|Q~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \kr|kd|scan|count|reg|ff3|Q~1_combout\ = \kr|kd|scan|count|reg|ff3|Q~q\ $ (((\kr|kd|scan|mux|Y~1_combout\ & (!\kr|kd|scan|count|reg|ff3|Q~0_combout\ & \kr|kd|scan|count|reg|ff2|Q~q\))))
...
PORT MAP (
	...
	datab => \kr|kd|scan|count|reg|ff3|Q~0_combout\,
	datac => \kr|kd|scan|count|reg|ff3|Q~q\,
	datad => \kr|kd|scan|count|reg|ff2|Q~q\,
	combout => \kr|kd|scan|count|reg|ff3|Q~1_combout\);
...
PORT MAP (
	clk => \kr|kd|clock|tmp~clkctrl_outclk\,
	d => \kr|kd|scan|count|reg|ff3|Q~1_combout\,
	clrn => \ALT_INV_Reset~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \kr|kd|control|Selector0~0_combout\ = (\kr|kd|scan|mux|Y~1_combout\ & (\kr|kd|control|CurrentState.FIRST~q\ & 
...
-- (!\kr|kd|scan|mux|Y~1_combout\ & (((\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\)) # 
-- (!\kr|kd|control|CurrentState.THIRD~q\)))
...
-- Equation(s):
-- \kr|kd|scan|count|reg|ff1|Q~0_combout\ = \kr|kd|scan|count|reg|ff1|Q~q\ $ (((\kr|kd|scan|mux|Y~1_combout\ & (\kr|kd|scan|count|reg|ff0|Q~q\ & !\kr|kd|control|CurrentState.FIRST~q\))))
...
-- Equation(s):
-- \kr|kd|scan|mux|Y~0_combout\ = (\kr|kd|scan|count|reg|ff1|Q~q\ & ((\kr|kd|scan|count|reg|ff0|Q~q\) # ((\I[2]~input_o\)))) # (!\kr|kd|scan|count|reg|ff1|Q~q\ & (!\kr|kd|scan|count|reg|ff0|Q~q\ & (\I[0]~input_o\)))
...
-- Equation(s):
-- \kr|kd|control|Selector1~0_combout\ = (\kr|kd|scan|mux|Y~1_combout\ & (!\auto_hu
-- b|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\ & (\kr|kd|control|CurrentState.SECOND~q\))) # 
-- (!\kr|kd|scan|mux|Y~1_combout\ & (((\kr|kd|control|CurrentState.SECOND~q\) # (!\kr|kd|control|CurrentState.FIRST~q\))))
...
\sl|sr|fsc|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sl|sr|fsc|Q~0_combout\ = !\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][3]~q\
...
PORT MAP (
	clk => \CLK~inputclkctrl_outclk\,
	d => \sl|sr|fsc|Q~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \sl|sr|fsc|Q~q\);

-- Location: CLKCTRL_G5
\sl|sr|fsc|Q~clkctrl\ : fiftyfivenm_clkctrl
-- pragma translate_off
GENERIC MAP (
	clock_type => "global clock",
	ena_register_mode => "none")
-- pragma translate_on
PORT MAP (
	inclk => \sl|sr|fsc|Q~clkctrl_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \sl|sr|fsc|Q~clkctrl_outclk\);
...
\sl|sr|f|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sl|sr|f|Q~0_combout\ = !\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][1]~q\
...
-- Equation(s):
-- \sl|sr|c|reg|ff2|Q~0_combout\ = \sl|sr|c|reg|ff2|Q~q\ $ (((\sl|sr|c|reg|ff0|Q~q\ & (\sl|sr|sc|CurrentState.SECOND~q\ & \sl|sr|c|reg|ff1|Q~q\))))
...
-- pragma translate_on
PORT MAP (
	clk => \sl|sr|fsc|ALT_INV_Q~clkctrl_outclk\,
...
-- Equation(s):
-- \sl|lcdd|cup|ad|fa3|Co~0_combout\ = (\sl|lcdd|cup|reg|ff1|Q~q\ & (\sl|lcdd|cup|reg|ff2|Q~q\ & (\sl|lcdd|CurrentState.SECOND~q\ & \sl|lcdd|cup|reg|ff0|Q~q\)))
...
-- Equation(s):
-- \sl|lcdd|cup|reg|ff3|Q~0_combout\ = \sl|lcdd|cup|ad|fa3|Co~0_combout\ $ (\sl|lcdd|cup|reg|ff3|Q~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \sl|lcdd|cup|ad|fa3|Co~0_combout\,
...
-- Equation(s):
-- \sl|lcdd|Selector2~0_combout\ = (!\sl|lcdd|cup|reg|ff0|Q~q\ & (\sl|lcdd|cup|reg|ff2|Q~q\ & (!\sl|lcdd|cup|reg|ff1|Q~q\ & \sl|lcdd|cup|reg|ff3|Q~q\)))
...
-- Equation(s):
-- \sl|lcdd|Selector1~0_combout\ = (\sl|lcdd|CurrentState.FIRST~q\ & (((\sl|lcdd|CurrentState.SECOND~q\ & !\sl|lcdd|Selector2~0_combout\)))) # (!\sl|lcdd|CurrentState.FIRST~q\ & ((\sl|sr|sc|CurrentState.THIRD~q\) # ((\sl|lcdd|CurrentState.SECOND~q\ & 
-- !\sl|lcdd|Selector2~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \sl|lcdd|CurrentState.FIRST~q\,
	datab => \sl|sr|sc|CurrentState.THIRD~q\,
	datac => \sl|lcdd|CurrentState.SECOND~q\,
	datad => \sl|lcdd|Selector2~0_combout\,
...
-- Equation(s):
-- \sl|lcdd|Selector2~1_combout\ = (\sl|lcdd|CurrentState.SECOND~q\ & ((\sl|lcdd|Selector2~0_combout\) # ((\sl|sr|sc|CurrentState.THIRD~q\ & \sl|lcdd|CurrentState.THIRD~q\)))) # (!\sl|lcdd|CurrentState.SECOND~q\ & (\sl|sr|sc|CurrentState.THIRD~q\ & 
...
PORT MAP (
	datab => \sl|lcdd|CurrentState.THIRD~q\,
	datad => \sl|sr|sc|CurrentState.FORTH~q\,
	combout => \sl|sr|sc|Selector0~0_combout\);

-- Location: LCCOMB_X43_Y34_N26
\sl|sr|sc|Selector0~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \sl|sr|sc|Selector0~2_combout\ = (!\sl|sr|sc|Selector0~0_combout\ & ((\sl|sr|f|Q~q\) # ((!\sl|sr|sc|Selector0~1_combout\ & \sl|sr|sc|CurrentState.FIRST~q\))))
...
-- Equation(s):
-- \sl|sr|sc|Selector2~0_combout\ = (!\sl|sr|c|reg|ff1|Q~q\ & (\sl|sr|c|reg|ff2|Q~q\ & (\sl|sr|c|reg|ff0|Q~q\ & !\sl|sr|f|Q~q\)))
...
-- Equation(s):
-- \sl|sr|sc|Selector1~0_combout\ = (\sl|sr|f|Q~q\ & (!\sl|sr|sc|CurrentState.THIRD~q\ & !\sl|sr|sc|CurrentState.FORTH~q\))
