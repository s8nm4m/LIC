...
-- Equation(s):
-- \kr|kd|scan|count|ad|fa2|Co~0_combout\ = (!\kr|kd|scan|mux|Y~1_combout\ & (!\kr|kd|control|CurrentState~q\ & (!\kr|kd|scan|count|reg|ff1|Q~q\ & !\kr|kd|scan|count|reg|ff0|Q~q\)))
...
-- pragma translate_on
PORT MAP (
	datab => \kr|kd|scan|count|reg|ff3|Q~_wirecell_combout\,
	datac => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|shadow_jsm|state\(3),
...
-- pragma translate_on
PORT MAP (
	datab => \kr|kd|scan|count|reg|ff1|Q~_wirecell_combout\,
	datac => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|shadow_jsm|state\(3),
...
-- Equation(s):
-- \kr|kd|control|NextState~0_combout\ = (\kr|kd|scan|mux|Y~1_combout\) # ((!\auto_
-- hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irf_reg[1][0]~q\ & \kr|kd|control|CurrentState~q\))
...
-- Equation(s):
-- \kr|kd|scan|count|ad|fa2|S~combout\ = \kr|kd|scan|count|reg|ff1|Q~q\ $ (((\kr|kd|scan|mux|Y~1_combout\) # ((\kr|kd|control|CurrentState~q\) # (\kr|kd|scan|count|reg|ff0|Q~q\))))
...
-- Equation(s):
-- \kr|kd|scan|mux|Y~0_combout\ = (\kr|kd|scan|count|reg|ff0|Q~q\ & ((\kr|kd|scan|count|reg|ff1|Q~q\ & (!\I[0]~input_o\)) # (!\kr|kd|scan|count|reg|ff1|Q~q\ & ((!\I[2]~input_o\))))) # (!\kr|kd|scan|count|reg|ff0|Q~q\ & (((!\kr|kd|scan|count|reg|ff1|Q~q\))))
...
-- Equation(s):
-- \kr|kd|scan|mux|Y~1_combout\ = (\kr|kd|scan|count|reg|ff0|Q~q\ & (((\kr|kd|scan|mux|Y~0_combout\)))) # (!\kr|kd|scan|count|reg|ff0|Q~q\ & ((\kr|kd|scan|mux|Y~0_combout\ & (!\I[3]~input_o\)) # (!\kr|kd|scan|mux|Y~0_combout\ & ((!\I[1]~input_o\)))))
...
-- Equation(s):
-- \kr|kd|scan|count|mux|Y~2_combout\ = (\Reset~input_o\) # (\kr|kd|scan|count|reg|ff0|Q~q\ $ (((!\kr|kd|scan|mux|Y~1_combout\ & !\kr|kd|control|CurrentState~q\))))
